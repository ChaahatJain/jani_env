...
namespace {
    ...
    constexpr int ACTION_PARK = 5; // Never choose this. Always try to recover.
}


ActionLabel_type TwoWayLinePark::get_action(const StateValues& state_values) {
...
// ./PlaJA --engine QL_AGENT --print-stats --evaluation-mode --trace-episodes 50 --save-agent-actions test.json --prop 1 --initial-state-enum sample --num-episodes 3 --max-length-episode 2000 --teacher-name TwoWayLinePark --model-file ../../PlaJABenchmarks/benchmarks_archive/icaps26_fault_fixing/jani_models_and_teachers/two_way_line/models/non_det_with_park/two_way_line.jani --additional-properties ../../PlaJABenchmarks/benchmarks_archive/icaps26_fault_fixing/jani_models_and_teachers/two_way_line/additional_properties/safety_verification/non_det_with_park/compact_starts_no_predicates/two_way_line/pa_two_way_line_compact_starts_no_predicates.jani --ensemble-interface ../../PlaJABenchmarks/benchmarks_archive/icaps26_fault_fixing/jani_models_and_teachers/two_way_line/networks/non_det_with_park/two_way_line/two_way_line_64_64.jani2nnet 